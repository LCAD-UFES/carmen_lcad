...
typedef enum
{
	...
	TASK_MANAGER_GET_BALE_FROM_PILE,
	TASK_MANAGER_PUT_BALE_ON_THE_TRUCK,
	TASK_MANAGER_PUT_BALE_ON_TOP,
	TASK_MANAGER_GET_BALE_FROM_PILE_YOLO,
	TASK_MANAGER_REPEAT,
	TASK_MANAGER_GO,
	TASK_MANAGER_STOP,
	...
	TASK_MANAGER_START_ON_HIDDEN_POSE,
} carmen_task_manager_task_type;


#define print_task(x) ( \
	(x == TASK_MANAGER_NONE)? "NONE": \
	(x == TASK_MANAGER_GET_BALE_FROM_PILE)? "GET_BALE_FROM_PILE": \
	(x == TASK_MANAGER_PUT_BALE_ON_THE_TRUCK)? "PUT_BALE_ON_THE_TRUCK": \
	(x == TASK_MANAGER_PUT_BALE_ON_TOP)? "PUT_BALE_ON_TOP0": \
	(x == TASK_MANAGER_GET_BALE_FROM_PILE_YOLO)? "GET_BALE_FROM_PILE_YOLO": \
