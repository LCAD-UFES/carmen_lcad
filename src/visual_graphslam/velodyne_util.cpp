...
void
accumulate_partial_scan(carmen_velodyne_variable_scan_message *velodyne_message, sensor_parameters_t *velodyne_params, sensor_data_t *velodyne_data)
{
...
int
accumulate_clouds(carmen_velodyne_variable_scan_message *velodyne_message, char *velodyne_storage_dir)
{
