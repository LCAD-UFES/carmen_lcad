/*
 * voslam_messages_interpolation.cpp
 *
 *  Created on: Mar 11, 2013
 *      Author: lauro
 */

#include "voslam_messages_interpolation.h"

template <typename M1, typename M2>
class VoslamMessagesInterpolation {

public:

	VoslamMessagesInterpolation(int list_size);
	...
	virtual ~VoslamMessagesInterpolation();
...
template <typename M1, typename M2>
VoslamMessagesInterpolation<M1, M2>::VoslamMessagesInterpolation(int list_size) {
...
template <typename M1, typename M2>
void VoslamMessagesInterpolation<M1, M2>::AddMessageToInterpolationList(M1 *message)
{
...
template <typename M1, typename M2>
M1 VoslamMessagesInterpolation<M1, M2>::InterpolateMessages(M2 *message)
{
	M1 nearest_message;
	int nearest_index = 0;
...
template <typename M1, typename M2>
VoslamMessagesInterpolation<M1, M2>::~VoslamMessagesInterpolation() {
