...
class Detector
{
	 ...
	 */
	void update_moving_object_velocity(carmen_robot_and_trailers_traj_point_t &robot_pose);
...
public:
	...
	carmen_robot_and_trailers_traj_point_t get_moving_obstacle_position(void);
	double get_moving_obstacle_distance(carmen_robot_and_trailers_traj_point_t robot_pose);
};
