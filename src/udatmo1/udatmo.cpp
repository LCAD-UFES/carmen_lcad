...
double
udatmo_get_moving_obstacle_distance(carmen_robot_and_trailers_traj_point_t robot_pose, carmen_robot_ackerman_config_t *robot_config __attribute__ ((unused)))
{
