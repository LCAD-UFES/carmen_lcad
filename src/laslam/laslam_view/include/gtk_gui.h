#ifndef CARMEN_LASLAM_GTK_GUI_H
#define CARMEN_LASLAM_GTK_GUI_H
...
private:
	...
	struct Controls
	{
		...
		GtkToggleButton * btnDrawLandmarkPoints;
...
public:
	...
	void addVisualOdometryPose(carmen_vector_3D_t visual_odometry_pose);
	void addLandmarkPoseToLandmarksList(carmen_vector_3D_t landmark_pose, unsigned char* crop);
