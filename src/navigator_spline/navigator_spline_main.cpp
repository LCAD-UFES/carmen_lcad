...
static carmen_robot_and_trailers_traj_point_t poses[MAX_POSITIONS + EXTRA_POSITIONS + 100];


static void tracker_position_handler(carmen_tracker_position_message *message);
void publish_spline_path_message(carmen_robot_and_trailers_traj_point_t *poses, int number_of_poses);
static void publish_spline_goal_message(carmen_robot_and_trailers_traj_point_t poses);
...
void
publish_spline_path_message(carmen_robot_and_trailers_traj_point_t *poses, int number_of_poses)
{
	IPC_RETURN_TYPE err;
...
void publish_spline_goal_message(carmen_robot_and_trailers_traj_point_t poses)
{
	IPC_RETURN_TYPE err;
