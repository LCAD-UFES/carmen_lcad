...
carmen_obstacle_distance_mapper_compact_map_level1_message_handler(carmen_obstacle_distance_mapper_compact_map_message *message)
{
	...
	GlobalState::distance_map_level1 = &distance_map;
}
...
//			(carmen_handler_t) carmen_obstacle_distance_mapper_map_message_handler, CARMEN_SUBSCRIBE_LATEST);
	...
	if (max_height_level > 0)
		carmen_obstacle_distance_mapper_subscribe_multi_height_compact_map_message(NULL,
			(carmen_handler_t) carmen_obstacle_distance_mapper_compact_map_level1_message_handler, CARMEN_SUBSCRIBE_LATEST, 1);
