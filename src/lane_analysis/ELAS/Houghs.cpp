...
vector<HoughLine> Houghs::getHoughs(const Mat1b &mapa1, const Rect &roi, vector<HoughLine> &houghsAdjacent, const int maxNumLines, int houghThresholdInicial, int houghStep, double houghMinLineLength, double houghMaxLineGap) {
