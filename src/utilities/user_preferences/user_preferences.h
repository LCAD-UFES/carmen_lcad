...
void user_preferences_read(const char *module, user_param_t *param_list, int num_items, const char *filename);

void user_preferences_read_commandline(int argc, char **argv, user_param_t *param_list, int num_items);

void user_preferences_save(const char *module, user_param_t *param_list, int num_items, const char *filename);
