...
static carmen_navigator_gui_map_view_message last_message;
...
void
update_fps(carmen_navigator_gui_map_view_message* image_msg)
{
...
static void
image_handler(carmen_navigator_gui_map_view_message* msg)
{
    double window_scale;
    int window_height;
...
main(int argc, char **argv)
{
	...
	sprintf(window_name, "2D Map View");
	...
	carmen_navigator_gui_subscribe_map_view_message(NULL, (carmen_handler_t) image_handler, CARMEN_SUBSCRIBE_LATEST);
	carmen_ipc_dispatch();
	return 0;
}
