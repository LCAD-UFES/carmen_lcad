...
GtkGui::GtkGui()
{
	...
	options_.drawSaliencyPoints = true;
...
void GtkGui::updateControls()
{
	...
	gtk_toggle_button_set_active(controls_.btnDrawSaliencyPoints,    options_.drawSaliencyPoints);
...
void GtkGui::setRobotCovarianceElipse(double angle, double major_axis, double minor_axis)
{
	drawer3D_->setRobotCovarianceElipse(angle, major_axis, minor_axis);
}

void GtkGui::setNeuralSaliency(carmen_vector_3D_t neural_saliency)
{
	drawer3D_->setNeuralSaliency(neural_saliency);
}

void GtkGui::setNeuralCorrespondence(carmen_vector_3D_t neural_correspondence)
{
	drawer3D_->setNeuralCorrespondence(neural_correspondence);
}

void GtkGui::setNeuralPose(carmen_pose_3D_t neural_pose)
{
	drawer3D_->setNeuralPose(neural_pose);
}

void GtkGui::setLocalizeAckermanPose(carmen_pose_3D_t localize_pose)
{
	drawer3D_->setLocalizeAckermanPose(localize_pose);
}

void GtkGui::setCameraPose(carmen_pose_3D_t camera_pose)
{
	drawer3D_->setCameraPose(camera_pose);
}

void GtkGui::addOdometryPose(carmen_vector_3D_t odometry_pose)
{
	drawer3D_->addOdometryPose(odometry_pose);
}
...
void GtkGui::setUpGTK()
{
	...
	if( ! gtk_builder_add_from_file(builder, "../../carmen/data/gui/neural_slam.glade", &error ) )
	{
	...
	controls_.btnDrawSaliencyPoints = GTK_TOGGLE_BUTTON(gtk_builder_get_object(builder, "btnDrawSaliencies"));
