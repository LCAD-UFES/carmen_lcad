...
static carmen_robot_and_trailers_traj_point_t robot_pose;
static int robot_initialized = 0;
static carmen_robot_and_trailers_traj_point_t goal_list[GOAL_LIST_SIZE];
...
void
add_goal_to_goal_list(int &goal_index, carmen_robot_and_trailers_traj_point_t &current_goal, int &current_goal_rddf_index, int rddf_pose_index,
...
{
	carmen_robot_and_trailers_traj_point_t new_car_traj_point = rddf->poses[rddf_pose_index];
	carmen_robot_and_trailers_pose_t new_car_pose = carmen_collision_detection_displace_car_pose_according_to_car_orientation(&new_car_traj_point, displacement);
...
double
datmo_get_moving_obstacle_distance(carmen_robot_and_trailers_traj_point_t robot_pose, carmen_robot_ackerman_config_t *robot_config)
{
	if (behavior_selector_use_symotha)
...
get_parameters_for_filling_in_goal_list(int &moving_object_in_front_index, int &last_obstacle_index, int &last_obstacle_free_waypoint_index,
		...
		carmen_robot_and_trailers_traj_point_t current_goal, int current_goal_rddf_index,
		carmen_moving_objects_point_clouds_message *current_moving_objects,
...
bool
recent_moving_object_near_this_rddf_pose(carmen_robot_and_trailers_traj_point_t pose, carmen_robot_and_trailers_traj_point_t moving_obstacle_pose,
...
static void
clear_cells_below_robot(carmen_robot_and_trailers_traj_point_t pose)
{
...
void
behavior_selector_update_robot_pose(carmen_robot_and_trailers_traj_point_t pose)
{
...
int
compute_stop_pose_rddf_index(carmen_robot_and_trailers_traj_point_t robot_state, carmen_rddf_road_profile_message *rddf_vector, int rddf_size,
...
carmen_robot_and_trailers_traj_point_t *
set_goal_list(int &current_goal_list_size, carmen_robot_and_trailers_traj_point_t *&first_goal, int &first_goal_type,
		...
		carmen_behavior_selector_state_message behavior_selector_state_message, double timestamp)
{
	...
	int goal_index = 0;
	carmen_robot_and_trailers_traj_point_t current_goal = robot_pose;
...
//	printf("v %lf\n", datmo_speed_front());
	...
	static carmen_robot_and_trailers_traj_point_t previous_first_goal;


#ifdef PRINT_UDATMO_LOG

	carmen_robot_and_trailers_traj_point_t front_obst = udatmo_get_moving_obstacle_position();
	double front_obst_velocity = udatmo_speed_front();

	carmen_robot_and_trailers_traj_point_t left_obst = udatmo_get_moving_obstacle_position_left();
	double left_obst_velocity = udatmo_speed_left();

	carmen_robot_and_trailers_traj_point_t right_obst = udatmo_get_moving_obstacle_position_right();
