...
typedef enum
{
	...
	BEHAVIOR_SELECTOR_PARK_SEMI_TRAILER,
	BEHAVIOR_SELECTOR_PARK_TRUCK_SEMI_TRAILER,
	BEHAVIOR_SELECTOR_MOVE_TO_ENGAGE_POSE,
	BEHAVIOR_SELECTOR_GET_ENGAGE_POSE,
...
typedef enum
{
	...
	Stopping_At_Busy_Queue,
	Stopped_At_Busy_Queue_S0,
	Stopped_At_Busy_Queue_S1,
	Stopped_At_Busy_Queue_S2,
	Stopping_At_Yield,
	Stopped_At_Yield_S0,
	Stopped_At_Yield_S1,
	Stopped_At_Yield_S2,
	...
	Stopping_To_Pedestrian,
	Stopped_At_Pedestrian_S0,
	Stopped_At_Pedestrian_S1,
	Stopped_At_Pedestrian_S2,
...
enum
{
	...
	CARMEN_BEHAVIOR_SELECTOR_ENGAGE_COLLISION_GEOMETRY = 4,
};
...
#define CARMEN_BEHAVIOR_SELECTOR_PATH_GOALS_AND_ANNOTATIONS_MESSAGE_FMT "{int, int, <{double, double, double, int, [double:5], double, double}:1>, <{double, double, double, int, [double:5], double, double}:2>, <int:1>, <int:1>, int, <{double, double, double, int, [double:5], double, double}:7>, double, string}"
