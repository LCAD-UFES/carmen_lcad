...
{
	carmen_robot_and_trailers_pose_t displaced_robot_position = carmen_collision_detection_displace_car_pose_according_to_car_orientation(&robot_pose, displacement);

	carmen_robot_and_trailers_traj_point_t displaced_robot_pose = robot_pose;
...
bool
nearest_pose_is_the_final_pose(carmen_robot_and_trailers_traj_point_t current_robot_pose_v_and_phi)
{
...
bool
must_yield_ahead(path_collision_info_t path_collision_info, carmen_robot_and_trailers_traj_point_t current_robot_pose_v_and_phi,
		double timestamp)
{
	static double last_must_yield_timestamp = 0.0;
...
get_final_goal()
{
	carmen_robot_and_trailers_traj_point_t *final_goal = NULL;
...
bool
red_traffic_light_ahead(carmen_robot_and_trailers_traj_point_t current_robot_pose_v_and_phi, double timestamp)
{
...
double
get_velocity_at_next_annotation(carmen_annotation_t *annotation, carmen_robot_and_trailers_traj_point_t current_robot_pose_v_and_phi,
		...
		double timestamp)
{
	...
	if ((annotation->annotation_type == RDDF_ANNOTATION_TYPE_TRAFFIC_LIGHT_STOP) &&
		...
		v = 20.0 / 3.6;
				 ...
				 (annotation->annotation_code == RDDF_ANNOTATION_CODE_SPEED_LIMIT_25))
			v = 25.0 / 3.6;
	else if ((annotation->annotation_type == RDDF_ANNOTATION_TYPE_SPEED_LIMIT) &&
...
double
distance_to_moving_obstacle_annotation(carmen_robot_and_trailers_traj_point_t current_robot_pose_v_and_phi)
{
	carmen_annotation_t *nearest_velocity_related_annotation = get_nearest_velocity_related_annotation(last_rddf_annotation_message,
				&current_robot_pose_v_and_phi, wait_start_moving);
...
double
compute_distance_within_rddf(carmen_vector_3D_t annotation_point, carmen_robot_and_trailers_traj_point_t  current_robot_pose_v_and_phi)
{
...
double
effective_distance_to_annotation(carmen_annotation_t *annotation, carmen_robot_and_trailers_traj_point_t *current_robot_pose_v_and_phi)
{
...
double
set_goal_velocity_according_to_annotation(carmen_robot_and_trailers_traj_point_t *goal, int goal_type,
		...
		carmen_robot_and_trailers_traj_point_t *current_robot_pose_v_and_phi)
{
	...
	static carmen_robot_and_trailers_traj_point_t previous_final_goal_point = {};
...
double
set_goal_velocity_according_to_state_machine(carmen_robot_and_trailers_traj_point_t *goal,
...
//	printf("max_centripetal_acceleration %4.2lf, dist_to_max_curvature %5.2lf\n", max_centripetal_acceleration, dist_to_max_curvature);
	...
	if (max_centripetal_acceleration > robot_max_centripetal_acceleration)
	{
		...
		{
			carmen_robot_and_trailers_traj_point_t current_robot_pose_v_and_phi = get_robot_pose();
...
double
limit_maximum_velocity_according_to_maximum_steering_command_rate(carmen_robot_and_trailers_traj_point_t *goal,
		carmen_robot_and_trailers_traj_point_t *current_robot_pose_v_and_phi,
		carmen_robot_and_trailers_traj_point_t *poses_ahead, int number_of_poses)
{
...
double
compute_dist_walked_from_robot_to_goal(carmen_robot_and_trailers_traj_point_t *poses_ahead, carmen_robot_and_trailers_traj_point_t *goal_pose, int num_poses)
{
	double s_range = 0.0;
...
double
set_goal_velocity_according_to_general_moving_obstacle(carmen_robot_and_trailers_traj_point_t *goal,
		carmen_robot_and_trailers_traj_point_t *current_robot_pose_v_and_phi __attribute__ ((unused)),
...
double
set_goal_velocity_according_to_last_speed_limit_annotation(carmen_robot_and_trailers_traj_point_t *goal)
{
...
int
set_goal_velocity(carmen_robot_and_trailers_traj_point_t *goal, carmen_robot_and_trailers_traj_point_t *current_robot_pose_v_and_phi,
