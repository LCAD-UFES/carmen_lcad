...
//	int last_obstacle_index = -1;
//	int j = 0;
//	static long int hit_obstacle_memory = -10;
...
//
//		if (rddf->annotations[i] == RDDF_ANNOTATION_TYPE_PEDESTRIAN_TRACK)
//		{
//			printf("Hit(%d) %d! (memory: %ld)\n", hit_obstacle, hit_count++, hit_obstacle_memory);
//
//			if(hit_obstacle || (hit_obstacle_memory > 0))
//			{
...
//				{
//					hit_obstacle_memory++;
//					if(hit_obstacle_memory > 10)
//						hit_obstacle_memory = 10;
//				}
//				else
//				{
//					printf("Non Hit\n");
...
//		}
//
//		else if (((distance >= distance_between_waypoints) &&
