...
carmen_rddf_annotation_message *annotation_msg;
...
//	{
		...
		for (int i = 0; i < annotation_msg->num_annotations; i++)
		{
			if (annotation_msg->annotations[i].annotation_type == 8)
			{
				carmen_position_t object_on_image = convert_rddf_pose_to_point_in_image(annotation_msg->annotations[i].annotation_point.x, annotation_msg->annotations[i].annotation_point.y, annotation_msg->annotations[i].annotation_point.z,
				...
				printf("%s %d %d %lf %lf %lf\n", annotation_msg->annotations[i].annotation_description, annotation_msg->annotations[i].annotation_code, annotation_msg->annotations[i].annotation_type, annotation_msg->annotations[i].annotation_point.x, annotation_msg->annotations[i].annotation_point.y, annotation_msg->annotations[i].annotation_point.z);
			}
		}

//		carmen_position_t object_on_image = convert_rddf_pose_to_point_in_image(7757493.704663, -364151.945918, 5.428209
//		carmen_position_t object_on_image2 = convert_rddf_pose_to_point_in_image(7757498.416323, -364158.291071, 5.631667
//		carmen_position_t object_on_image3 = convert_rddf_pose_to_point_in_image(7757492.914793, -364155.064267, 5.450262
//
