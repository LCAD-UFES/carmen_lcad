...
void
carmen_base_ackerman_publish_motion_command(carmen_robot_and_trailers_motion_command_t *motion_command, int num_motion_commands, double timestamp)
{
	IPC_RETURN_TYPE err;
...
void
carmen_base_ackerman_publish_motion_command_2(carmen_robot_and_trailers_motion_command_t *motion_command, int num_motion_commands, double timestamp)
{
	IPC_RETURN_TYPE err;
	static carmen_base_ackerman_motion_command_message msg;
	static int first_time = 1;
