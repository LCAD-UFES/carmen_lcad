...
static int aligning;
static carmen_robot_and_trailers_traj_point_t last_goal;//TODO create trajectory point for ackerman?
static carmen_robot_and_trailers_traj_point_t start_position;
static carmen_robot_and_trailers_traj_point_t goal;
