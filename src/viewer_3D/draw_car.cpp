...
void calculate_trailer_positions(CarDrawer *carDrawer, double beta[MAX_NUM_TRAILERS], int num_semi_trailers, double positions[MAX_NUM_TRAILERS][3], int drawing_model = 1)
{
...
void draw_collision_range(CarDrawer *carDrawer, carmen_pose_3D_t pose, double beta[MAX_NUM_TRAILERS], int semi_trailer_engaged)
{
	glPushMatrix();
...
void draw_car_outline(CarDrawer *carDrawer, double beta[MAX_NUM_TRAILERS], int semi_trailer_engaged)
{
	// Car
	glPushMatrix();
...
void draw_car(CarDrawer *carDrawer, double beta[MAX_NUM_TRAILERS], int semi_trailer_engaged)
{
		...
		for (int semi_trailer_id = 1; semi_trailer_id <= carDrawer->semi_trailer_config.num_semi_trailers; semi_trailer_id++)
		{
			...
			for (int i = 0; i < semi_trailer_id; i++)
			{
				...
				glTranslatef(trailer_positions[i][0], trailer_positions[i][1], trailer_positions[i][2]);
     			...
     			glTranslatef(
                    carDrawer->semi_trailer_pose[semi_trailer_id-1].position.x,
                    carDrawer->semi_trailer_pose[semi_trailer_id-1].position.z,
                    carDrawer->semi_trailer_pose[semi_trailer_id-1].position.y
                );


            glRotatef(-carmen_radians_to_degrees(carDrawer->semi_trailer_pose[semi_trailer_id-1].orientation.yaw), 0.0f, 1.0f, 0.0f);
            glRotatef(-carmen_radians_to_degrees(carDrawer->semi_trailer_pose[semi_trailer_id-1].orientation.pitch), 1.0f, 0.0f, 0.0f);
            glRotatef(-carmen_radians_to_degrees(carDrawer->semi_trailer_pose[semi_trailer_id-1].orientation.roll), 0.0f, 0.0f, 1.0f);

			glColor3f(0.3, 0.3, 0.3);
			if (semi_trailer_id == 2)
				glColor3f(1.0, 0.0, 0.0);
...
void draw_car_at_pose(CarDrawer *carDrawer, carmen_pose_3D_t pose, double beta[MAX_NUM_TRAILERS], int semi_trailer_engaged)
{
	glPushMatrix();
	glTranslatef(pose.position.x, pose.position.y, pose.position.z);
	glRotatef(carmen_radians_to_degrees(pose.orientation.yaw), 0.0f, 0.0f, 1.0f);
...
void draw_car_outline_at_pose(CarDrawer *carDrawer, carmen_pose_3D_t pose, double beta[MAX_NUM_TRAILERS], int semi_trailer_engaged)
{
