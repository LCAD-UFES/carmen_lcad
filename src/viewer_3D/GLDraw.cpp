...
void
draw_tracking_moving_objects(carmen_pose_3D_t pos, carmen_vector_3D_t velocity, double width, double height)
{

	rotation_matrix *rotate = compute_rotation_matrix(rotate, pos.orientation);
	carmen_vector_3D_t p1, p2, p3 , p4, t;
...
draw_laser_points (point_cloud *laser_points, point_cloud *laser_points_car, int laser_size)
{
    ...
    {
        int j;
        // printf("laser_points[i].num_points: %d\n", laser_points[i].num_points);
