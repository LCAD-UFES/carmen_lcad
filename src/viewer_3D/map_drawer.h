...
//void add_remission_map_message(map_drawer* m_drawer, carmen_map_server_localize_map_message *message,
//		carmen_vector_3D_t offset, carmen_pose_3D_t car_fused_pose, double map_zoom); @@@Braian
