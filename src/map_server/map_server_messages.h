...
#define CARMEN_MAP_SERVER_REQUEST_CURRENT_OFFLINE_MAP_LEVEL1_NAME "carmen_map_server_request_current_offline_map_level1_name"
...
#define CARMEN_MAP_SERVER_CURRENT_OFFLINE_MAP_LEVEL1_NAME  "carmen_map_server_current_offline_map_level1_name"
