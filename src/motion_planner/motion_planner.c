...
carmen_robot_and_trailers_motion_command_t motion_commands_vector[NUM_MOTION_COMMANDS_VECTORS][NUM_MOTION_COMMANDS_PER_VECTOR];
int nun_motion_commands[NUM_MOTION_COMMANDS_VECTORS];

carmen_robot_and_trailers_traj_point_t g_robot_position;
...
carmen_robot_and_trailers_traj_point_t *g_current_trajectory = NULL;
...
predict_new_robot_position(carmen_robot_and_trailers_traj_point_t current_robot_position, double v, double phi, double time, carmen_robot_ackerman_config_t *car_config)
{
	carmen_robot_and_trailers_traj_point_t new_robot_position;
	int i;
	double delta_time;
...
build_predicted_trajectory(carmen_robot_and_trailers_motion_command_t *motion_commands_vector, int num_motion_commands,
		carmen_robot_and_trailers_traj_point_t initial_pose)
{
...
static int
next_waypoint_astar(carmen_robot_and_trailers_traj_point_t *waypoint)
{
	if (path.path == NULL)
		return -1;
	//	int i;
...
static int
next_waypoint(carmen_robot_and_trailers_traj_point_t *waypoint, int* waypoint_index)
{
...
get_center_of_the_car_front_axel(carmen_robot_and_trailers_traj_point_t current_robot_position)
{
	carmen_robot_and_trailers_traj_point_t center_of_the_car_front_axel;
...
get_the_point_nearest_to_the_trajectory(int *point_in_trajectory_is,
		carmen_robot_and_trailers_traj_point_t current_robot_position,
		carmen_robot_and_trailers_traj_point_t waypoint,
		carmen_robot_and_trailers_traj_point_t center_of_the_car_front_axel)
{
...
#define	POINT_AFTER_SEGMENT			3
	...
	carmen_robot_and_trailers_traj_point_t v, w, p;
	double l2, t;
...
static int
phi_signal_negative(carmen_robot_and_trailers_traj_point_t origin, carmen_robot_and_trailers_traj_point_t source_v1,
		carmen_robot_and_trailers_traj_point_t source_v2)
{
	carmen_robot_and_trailers_traj_point_t v1, v2;
	double signal;
...
static double
get_motion_command_phi(double phi, double time, carmen_robot_and_trailers_traj_point_t current_robot_position,
		carmen_robot_and_trailers_traj_point_t center_of_the_car_front_axel, carmen_robot_and_trailers_traj_point_t point_in_trajectory)
{
...
static double
get_motion_command_time(carmen_robot_and_trailers_traj_point_t current_robot_position __attribute__ ((unused)))
{
...
void
print_motion_command(int i, carmen_robot_and_trailers_motion_command_t motion_command)
{
...
void
print_motion_command_vector(carmen_robot_and_trailers_motion_command_t *motion_commands_vector, int num_motion_commands)
{
	int i;
...
int
get_nearest_trajectory_point_index(carmen_robot_and_trailers_traj_point_t *trajectory, int trajectory_length,
		carmen_robot_and_trailers_traj_point_t *front_pose)
{
	int closest_index, i;
...
int
motion_planner_compute_trajectory(carmen_robot_and_trailers_motion_command_t *next_motion_commands_vector,
		carmen_robot_and_trailers_traj_point_t *trajectory, int trajectory_length, carmen_robot_and_trailers_traj_point_t current_robot_position,
		int num_motion_commands, double time_budget, double max_v)
{
	int trajectory_index, motion_command_index;
	carmen_robot_and_trailers_traj_point_t center_of_the_car_front_axel, point_in_trajectory;
...
int
motion_planner_compute_trajectory_old(carmen_robot_and_trailers_motion_command_t *next_motion_commands_vector,
		carmen_robot_and_trailers_traj_point_t *trajectory, int trajectory_length, carmen_robot_and_trailers_traj_point_t current_robot_position,
		int num_motion_commands, double time_budget, double max_v)
{
	int trajectory_index, motion_command_index;
...
{
	carmen_robot_and_trailers_motion_command_t *next_motion_commands_vector;
...
static void
send_trajectory_to_robot(carmen_robot_and_trailers_traj_point_t *trajectory, int trajectory_length)
{
	int i;
	...
	g_current_trajectory = (carmen_robot_and_trailers_traj_point_t *) malloc(trajectory_length * sizeof(carmen_robot_and_trailers_traj_point_t));
...
motion_planner_set_path(carmen_motion_planner_path_message *msg)
{
	if (replan == 1)
	{
		...
		path = *msg;
		path.path = (carmen_robot_and_trailers_traj_point_t *) malloc(sizeof(carmen_robot_and_trailers_traj_point_t) * path.path_size);
		memcpy(path.path, msg->path, sizeof(carmen_robot_and_trailers_traj_point_t) * path.path_size);
		min_delta_d = INTMAX_MAX;
		publish_plan();
	}
}
...
void
publish_astar_path(carmen_robot_and_trailers_traj_point_t *path, int path_size, carmen_robot_and_trailers_traj_point_t robot_position)
{
	carmen_robot_and_trailers_motion_command_t *next_motion_commands_vector;
	int next_motion_command_vector_index;
	if (path_size <= 0)
	...
	for (i = 0; i < path_size; i++)
	{
		...
		{
			carmen_robot_and_trailers_traj_point_t temp_point;
