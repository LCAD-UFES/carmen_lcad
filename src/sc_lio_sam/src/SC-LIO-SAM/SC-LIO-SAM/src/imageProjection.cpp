...
public:
    ...
    deskewFlag(0)
    {
        ...
        subLaserCloud = nh.subscribe<sensor_msgs::PointCloud2>(pointCloudTopic, std::max(5, slamQueueSize), &ImageProjection::cloudHandler, this, ros::TransportHints().tcpNoDelay());
