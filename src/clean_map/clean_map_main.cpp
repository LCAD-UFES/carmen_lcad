...
int update_and_merge_with_clean_map_saved_maps;
...
carmen_localize_ackerman_globalpos_message_handler(carmen_localize_ackerman_globalpos_message *globalpos_message)
{
	...
	clean_map_set_robot_pose_into_the_map(globalpos_message, update_cells_below_car);
	...
	if (ok_to_publish)
	{
		...
		for (int i = 0; i < NUM_VELODYNE_POINT_CLOUDS; i++)
		{
			if (sensors_data[0].points_timestamp[i] == globalpos_message->timestamp)
			{
				...
				run_clean_map(/*&sensors_params[0], &sensors_data[0], r_matrix_car_to_global*/);
...
{
	clean_map_velodyne_partial_scan(velodyne_message);
}
...
//{
//	clean_map_velodyne_variable_scan(1, message);
//}
//
//
//static void
...
//{
//	clean_map_velodyne_variable_scan(2, message);
//}
//
//
//static void
...
//{
//	clean_map_velodyne_variable_scan(3, message);
//}
//
//
//static void
...
//{
//	clean_map_velodyne_variable_scan(4, message);
//}
//
//
//static void
...
//{
//	clean_map_velodyne_variable_scan(5, message);
//}
//
//
//static void
...
//{
//	clean_map_velodyne_variable_scan(6, message);
//}
//
//
//static void
...
//{
//	clean_map_velodyne_variable_scan(7, message);
//}
//
//
//static void
...
//{
//	clean_map_velodyne_variable_scan(8, message);
//}
//
//
//static void
...
//{
//	clean_map_velodyne_variable_scan(9, message);
//}
...
offline_map_handler(carmen_map_server_offline_map_message *msg)
{
	...
	clean_map_change_map_origin_to_another_map_block(&map_origin);

	if (merge_with_offline_map)
		clean_map_merge_online_map_with_offline_map(&offline_map);
}
...
shutdown_module(int signo)
{
	if (signo == SIGINT)
	{
		...
		fprintf(stderr, "Shutdown clean_map_main\n");
		...
		carmen_robot_ackerman_config_t *p_car_config)
{
	...
	carmen_param_t param_list[] =
	{
			...
			{(char*)"mapper",  (char*)"update_and_merge_with_mapper_saved_maps", CARMEN_PARAM_ONOFF, &update_and_merge_with_clean_map_saved_maps, 0, NULL},
...
main(int argc, char **argv)
{
	...
	clean_map_initialize(&map_config, car_config);
