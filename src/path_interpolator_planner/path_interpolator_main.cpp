...
publish_interface_message(vector<carmen_point_t> &interpolated_path)
{
	...
	message.path = (carmen_ackerman_traj_point_t *) calloc (interpolated_path.size(), sizeof(carmen_ackerman_traj_point_t));
...
publish_path_planner_message(vector<carmen_point_t> &interpolated_path)
{
	...
	path = (carmen_ackerman_traj_point_t*) calloc (interpolated_path.size(), sizeof(carmen_ackerman_traj_point_t));
