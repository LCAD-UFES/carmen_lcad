...
GNUTERM = "wxt"
plot "./results_pid-steering.txt" using 14:8 with lines title "cc", "./results_pid-steering.txt" using 14:9 with lines title "dc", "./results_pid-steering.txt" using 14:10 with lines title "e", "./results_pid-steering.txt" using 14:11 with lines title "i", "./results_pid-steering.txt" using 14:($12/10) with lines title "d", "./results_pid-steering.txt" using 14:($13/1000) with lines title "s"
#    EOF
