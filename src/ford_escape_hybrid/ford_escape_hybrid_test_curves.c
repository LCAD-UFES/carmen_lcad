...
static carmen_robot_and_trailers_traj_point_t points_vector[10000000];
carmen_robot_and_trailers_motion_command_t motion_command_vector[10000000];
...
static int
build_points_vector(carmen_robot_and_trailers_traj_point_t *points_vector, int initial_index, double phi, double time, carmen_robot_ackerman_config_t *car_config)
{
	double t;
	int size = 0;
...
void
publish_navigator_ackerman_plan_message(carmen_robot_and_trailers_traj_point_t *points_vector, int size)
{
...
void
send_base_ackerman_command(carmen_robot_and_trailers_traj_point_t *path, int size)
{
	int i;
	for (i = 0; i < size; i++)
	{
