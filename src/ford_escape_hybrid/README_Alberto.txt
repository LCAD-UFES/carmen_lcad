./ford_escape_hybrid_tune_pid -max_v 0.5 -max_phi 15.0 -timer_period 1.0 -t1 8.0 -t2 4.0 -t3 8.0
./ford_escape_hybrid_tune_pid -max_v 0.0 -max_phi 10.0 -timer_period 1.0 -t1 8.0 -frequency 0.125
./ford_escape_hybrid_tune_pid -max_v 0.0 -max_phi 10.0 -timer_period 1.0 -t1 8.0 -t2 4.0 -t3 8.0
