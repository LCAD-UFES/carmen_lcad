...
plot "./results_pid-steering.txt" using ($14-k):8 with lines title "cc", "./results_pid-steering.txt" using ($14-k):9 with lines title "dc", "./results_pid-steering.txt" using ($14-k):10 with lines title "e", "./results_pid-steering.txt" using ($14-k):11 with lines title "i", "./results_pid-steering.txt" using ($14-k):($12/10) with lines title "d", "./results_pid-steering.txt" using ($14-k):($13/10) with lines title "s"
