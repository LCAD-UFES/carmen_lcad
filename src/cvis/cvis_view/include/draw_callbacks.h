...
extern "C" G_MODULE_EXPORT
void on_togglebutton6_toggled(GtkToggleButton * togglebutton,
                          GTKGui          * gui);

extern "C" G_MODULE_EXPORT
void on_togglebutton7_toggled(GtkToggleButton * togglebutton,
                          GTKGui          * gui);

extern "C" G_MODULE_EXPORT
void on_togglebutton8_toggled(GtkToggleButton * togglebutton,
                          GTKGui          * gui);

extern "C" G_MODULE_EXPORT
void on_togglebutton9_toggled(GtkToggleButton * togglebutton,
                          GTKGui          * gui);
