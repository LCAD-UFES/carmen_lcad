...
// (note que comecca de zero; assim, NUM_RDDF_ANNOTATION_TYPES eh igual ao ultimo codigo mais 1)
	#define NUM_RDDF_ANNOTATION_TYPES						21
	...
	#define RDDF_ANNOTATION_TYPE_ENGINE_BREAK				18
...
// (note que comecca de zero; assim, NUM_RDDF_ANNOTATION_CODES eh igual ao ultimo codigo mais 1)
	#define NUM_RDDF_ANNOTATION_CODES						47
	...
	#define RDDF_ANNOTATION_CODE_ENGINE_BREAK_ON			41
	#define RDDF_ANNOTATION_CODE_ENGINE_BREAK_OFF			42
