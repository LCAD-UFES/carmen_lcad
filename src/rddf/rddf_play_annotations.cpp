		...
		int num_poses_ahead_max, int *rddf_annotations)
{
	...
	int num_poses_ahead = carmen_search_next_poses_index(x, y, yaw, v, timestamp, poses_ahead, poses_back, num_poses_back,
			num_poses_ahead_max, rddf_annotations, carmen_rddf_perform_loop);
		...
		int num_poses_ahead_max, int *rddf_annotations, int test_orientation)
{
	...
	int num_poses_ahead = carmen_search_next_poses_index_and_test_orientation(x, y, yaw, v, poses_ahead, poses_back, num_poses_back, num_poses_ahead_max,
			rddf_annotations, test_orientation, carmen_rddf_perform_loop);
		...
		int carmen_rddf_num_poses_ahead, int carmen_rddf_num_poses_back)
{
	...
	else if (annotation_read_from_file[annotation_index].annotation_type == RDDF_ANNOTATION_TYPE_PEDESTRIAN_TRACK)
	{
		...
		{
			annotation_and_index annotation_i = {annotation_read_from_file[annotation_index], annotation_index};
			// if (pedestrian_track_busy_new(pedestrians_tracked, annotation_read_from_file[annotation_index]))
