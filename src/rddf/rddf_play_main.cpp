...
carmen_robot_and_trailers_pose_t carmen_rddf_end_point;

int carmen_rddf_nearest_waypoint_is_set = 0;
carmen_robot_and_trailers_pose_t carmen_rddf_nearest_waypoint_to_end_point;

carmen_robot_and_trailers_traj_point_t *carmen_rddf_poses_ahead = NULL;
static carmen_robot_and_trailers_traj_point_t *carmen_rddf_poses_back = NULL;
...
carmen_rddf_play_find_and_publish_poses_around_end_point(double x, double y, double yaw, int num_poses_desired, double timestamp)
{
	...
	carmen_robot_and_trailers_traj_point_t *poses_around_end_point;

	poses_around_end_point = (carmen_robot_and_trailers_traj_point_t *) calloc (num_poses_desired, sizeof(carmen_robot_and_trailers_traj_point_t));
...
{
	carmen_rddf_poses_ahead = (carmen_robot_and_trailers_traj_point_t *) calloc (carmen_rddf_num_poses_ahead_max, sizeof(carmen_robot_and_trailers_traj_point_t));
	carmen_rddf_poses_back = (carmen_robot_and_trailers_traj_point_t *) calloc (carmen_rddf_num_poses_ahead_max, sizeof(carmen_robot_and_trailers_traj_point_t));
