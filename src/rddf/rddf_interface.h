...
extern "C"
{
    ...
    void carmen_rddf_subscribe_update_annotation_message(carmen_rddf_update_annotation_message *message, carmen_handler_t handler, carmen_subscribe_t subscribe_how);
    ...
    void carmen_rddf_unsubscribe_update_annotation_message(carmen_handler_t handler);
    ...
    void carmen_rddf_publish_end_point_message(int number_of_poses_considered_near_endpoint, carmen_point_t point);
    ...
    void get_barrier_annotation_sizes(carmen_annotation_t *annotation, double *size_front, double *size_back);
