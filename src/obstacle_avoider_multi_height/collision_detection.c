...
double
carmen_obstacle_avoider_proximity_to_obstacles(carmen_point_t *localizer_pose, carmen_point_t local_point_to_check, // point_to_check_in_respect_to_car,
...
double
carmen_obstacle_avoider_compute_car_distance_to_closest_obstacles_multi_height(carmen_point_t *localizer_pose, carmen_point_t local_point_to_check, // point_to_check_in_respect_to_car,
carmen_robot_ackerman_config_t robot_config, carmen_obstacle_distance_mapper_map_message **distance_maps , double safety_distance)
{
	check_collision_config_initialization();
	for (int j =0; j <= global_max_height_level; j++)
		if (distance_maps[j] == NULL)
			return 0.0;
...
int
trajectory_pose_hit_obstacle_multi_height(carmen_ackerman_traj_point_t trajectory_pose, double safety_distance,
