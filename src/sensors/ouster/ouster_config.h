...
const ouster::OS1::lidar_mode mode = ouster::OS1::MODE_1024x20;
...
// in degrees - Carmen-ini lidar<ID>_vertical
const double ousterOS132_205_altitude_angles[32] = {
...
// in degrees
const double ousterOS132_205_azimuth_offsets[32] = {
...
// in degrees - Carmen-ini lidar<ID>_vertical
const double ousterOS132_208_altitude_angles[32] = {
	20.6, 19.34, 18.07, 16.8, 15.49, 14.19, 12.84, 11.48,
	10.13, 8.74, 7.36, 5.97, 4.56, 3.17, 1.77, 0.34,
	-1.06, -2.47, -3.87, -5.27, -6.66, -8.050000000000001, -9.449999999999999, -10.81,
	-12.16, -13.51, -14.84, -16.15, -17.45, -18.74, -19.97, -21.22
...
// in degrees
const double ousterOS132_208_azimuth_offsets[32] = {
	-1.40, -1.41, -1.40, -1.39, -1.41, -1.4, -1.41, -1.41,
	-1.41, -1.42, -1.40, -1.40, -1.41, -1.41, -1.41, -1.42,
	-1.41, -1.41, -1.40, -1.40, -1.40, -1.40, -1.41, -1.40,
	-1.40, -1.39, -1.40, -1.40, -1.41, -1.41, -1.38, -1.4
...
// in degrees 192.168.1.207 Carmen-ini lidar<ID>_vertical
const double ousterOS032_207_altitude_angles[32] = {
...
// in degrees 192.168.1.207
const double ousterOS032_207_azimuth_offsets[32] = {
...
// in degrees 192.168.1.206 Carmen-ini lidar<ID>_vertical
const double ousterOS032_206_altitude_angles[32] = {
		43.97, 40.96, 37.99, 35.01, 32.07, 29.15, 26.24, 23.34,
		20.47, 17.6, 14.76, 11.93, 9.109999999999999, 6.3, 3.5, 0.7,
		-2.1, -4.9, -7.7, -10.51, -13.32, -16.15, -18.99, -21.82,
		-24.67, -27.53, -30.42, -33.33, -36.24, -39.19, -42.17, -45.18
};


// in degrees 192.168.1.206
const double ousterOS032_206_azimuth_offsets[32] = {
		-3.19, -3.1, -3.03, -2.97, -2.92, -2.87, -2.85, -2.81,
		-2.79, -2.77, -2.76, -2.76, -2.76, -2.77, -2.79, -2.79,
		-2.81, -2.83, -2.86, -2.89, -2.93, -2.97, -3.02, -3.08,
		-3.14, -3.21, -3.3, -3.41, -3.51, -3.63, -3.79, -3.95
};
...
const double*
get_OS32_azimuth_offsets(char* ouster_ip)
{
	if (strcmp(ouster_ip, "192.168.1.205") == 0)
		return ousterOS132_205_azimuth_offsets;
	if (strcmp(ouster_ip, "192.168.1.206") == 0)
		return ousterOS032_206_azimuth_offsets;
	if (strcmp(ouster_ip, "192.168.1.207") == 0)
		return ousterOS032_207_azimuth_offsets;
	if (strcmp(ouster_ip, "192.168.1.208") == 0)
		return ousterOS132_208_azimuth_offsets;
