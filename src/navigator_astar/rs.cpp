...
/***********************************************************/
double reed_shepp(carmen_robot_and_trailers_traj_point_t start, carmen_robot_and_trailers_traj_point_t goal, int *numero,
...
/***********************************************************/
int fct_curve(int ty, int orientation, double val, carmen_robot_and_trailers_traj_point_t *start,
