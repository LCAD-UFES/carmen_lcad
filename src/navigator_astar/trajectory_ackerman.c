...
check_path_capacity(carmen_planner_path_p path)
{
	...
	{
		path->capacity = 20;
		path->points = (carmen_robot_and_trailers_traj_point_t *) calloc(path->capacity, sizeof(carmen_robot_and_trailers_traj_point_t));
	...
	else
	{
		while(path->length >= path->capacity)
		{
			...
			new_points = (carmen_robot_and_trailers_traj_point_t *) realloc(path->points,
					sizeof(carmen_robot_and_trailers_traj_point_t) * path->capacity);
...
int
carmen_planner_util_add_path_point(carmen_robot_and_trailers_traj_point_t point, carmen_planner_path_p path)
{
...
void
carmen_planner_util_insert_path_point(int index, carmen_robot_and_trailers_traj_point_t *current_point,
		carmen_planner_path_p path)
{
