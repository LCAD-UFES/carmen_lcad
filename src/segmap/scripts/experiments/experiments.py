...
experiments = [
        ...
        'test': ["log_volta_da_ufes-20180112-2.txt", "log_volta_da_ufes-20180907-2.txt", 
                  "log-volta-da-ufes-20181206.txt", "log-volta-da-ufes-noite-20181130.txt"]},
        ...
        {'map': 'log-jardim-da-penha-mapeamento-20181208.txt', 'test': ['log-jardim_da_penha-20181207-2.txt', 'log-jardim_da_penha-20181207.txt']}, 
...
GPS_XY_STD = 2.0
GPS_H_STD = 10.0
GICP_LOOPS_XY_STD = 0.5
GICP_LOOPS_H_STD = 5.0
