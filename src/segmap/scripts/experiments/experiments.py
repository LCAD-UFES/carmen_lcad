...
experiments = [
#        {'map': "log_volta_da_ufes-20180112.txt", 'test': ["log-volta-da-ufes-20181206.txt"]},
...
#        {'map': 'log-estacionamento-ambiental-20181208.txt', 'test': ['log-volta-da-ufes-20181207-estacionamento_ambiental.txt', 'log-volta-da-ufes-20181206-estacionamento-test.txt']}, 
