...
if __name__ == "__main__":
	...
	for e in experiments:
		...
		for t in e['test']:
			...
			cmd = carmen_path + "/src/segmap/graphslam_fast/graphslam /dados/%s ../carmen-ford-escape.ini /dados/data2//data_%s//graphslam_to_map.txt -o /dados/data2//data_%s//odom_calib.txt -l /dados/data2//data_%s//loops.txt --pf_loops /dados/data2//data_%s//localization_loops.txt --pf_to_map /dados/data2/data_%s/pf_loops_to_map.txt %s --pf_to_map_xy_std 0.2 --pf_to_map_angle_std 2 " % (t, t, t, t, t, t, args)
