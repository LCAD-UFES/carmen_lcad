...
if __name__ == "__main__":
	...
	for e in experiments:
		...
		for t in e['test']:
			...
			if ("brt" in t):
				args = "--gps_xy_std 50.00000 --gps_angle_std 50.000000 --gicp_loops_xy_std 0.300000 --gicp_loops_angle_std 1.000000 --pf_loops_xy_std 0.030000 --pf_loops_angle_std 3.000000 --gps_discontinuity_threshold 0.5 --gps_min_cluster_size 50 --gps_step 50"
			else:
