...
create_dataset(char *dataset_name)
{
	...
	if (!strcmp(dataset_name, "carmen"))
        ...
        dataset = new DatasetCarmen(960, 1280, "/dados/data/data_log_aeroporto_vila_velha_20170726-2.txt", 0);
...
main(int argc, char **argv)
{
	...
	char *map_name = "/dados/maps/maps_log_aeroporto_vila_velha_20170726-2.txt";
	char cmd[256];
