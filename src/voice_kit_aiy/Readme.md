...
- Pedirá usuário e senha. Se nao for o seu, dar Enter e digitar seu usuario do GitHub
...
- Alguns updates que podem ser necessaários:
    "$ sudo _pip/apt-get_ install --update _nome pkg_"
   - google
   - google-cloud
   - google-cloud-sdk
