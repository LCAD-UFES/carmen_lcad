...
namespace Houghs {
	vector<HoughLine> getHoughs(std::vector<bounding_box> bouding_boxes_list ,const Mat1b &mapa1, const Rect &roi, vector<HoughLine> &houghsAdjacent, const int maxNumLines = 200, int houghThresholdInicial = 20, int houghStep = 10, double houghMinLineLength = 5, double houghMaxLineGap = 5);
