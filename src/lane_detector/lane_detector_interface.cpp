...
// UNSUBSCRIBES
void
carmen_lane_unsubscribe(carmen_handler_t handler)
{
...
// SUBSCRIBES
void
carmen_lane_subscribe(carmen_lane_detector_lane_message_t *message, carmen_handler_t handler, carmen_subscribe_t subscribe_how)
{
