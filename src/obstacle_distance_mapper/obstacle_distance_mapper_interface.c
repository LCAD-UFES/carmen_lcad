...
void
carmen_grid_mapping_distance_map_subscribe_message(carmen_mapper_distance_map_message *message,
...
void
carmen_grid_mapping_publish_distance_map_message(carmen_mapper_distance_map *distance_map, double timestamp)
{
  IPC_RETURN_TYPE err;
