...
carmen_robot_and_trailers_motion_command_t motion_command_vector[MOTION_COMMAND_VECTOR_MAX_SIZE];

carmen_robot_and_trailers_motion_command_t path_motion_command[MOTION_COMMAND_VECTOR_MAX_SIZE];
