...
static int log_velodyne_variable_save_to_file = 1;
...
{
	//fprintf(stderr, "VV1");
	if (log_velodyne_variable_save_to_file)
...
int main(int argc, char **argv)
{
  ...
  if (log_velodyne){
	  ...
	  carmen_velodyne_subscribe_variable_scan_message1(NULL, (carmen_handler_t)
	    			velodyne_variable_scan_handler1,
	    			CARMEN_SUBSCRIBE_ALL);

	  carmen_velodyne_subscribe_variable_scan_message2(NULL, (carmen_handler_t)
	  	    			velodyne_variable_scan_handler2,
	  	    			CARMEN_SUBSCRIBE_ALL);

	  carmen_velodyne_subscribe_variable_scan_message3(NULL, (carmen_handler_t)
