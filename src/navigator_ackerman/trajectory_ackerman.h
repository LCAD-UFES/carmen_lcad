...
extern "C" {
	...
	int carmen_planner_util_add_path_point(carmen_robot_and_trailers_traj_point_t point,
			carmen_planner_path_p path);

	carmen_robot_and_trailers_traj_point_t *carmen_planner_util_get_path_point(int index,
			carmen_planner_path_p path);
