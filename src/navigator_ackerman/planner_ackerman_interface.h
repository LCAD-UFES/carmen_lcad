...
int carmen_planner_ackerman_update_robot(carmen_ackerman_traj_point_p new_position,
		carmen_navigator_config_t *nav_conf);

/** Updates the current goal, replans and regenerates the trajectory.
      Returns 1 if a new path was generated, otherwise returns 0 */

int carmen_planner_ackerman_update_goal(carmen_ackerman_traj_point_p new_goal, int any_orientation,
		carmen_navigator_config_t *nav_conf);
...
int carmen_planner_ackerman_next_waypoint(carmen_ackerman_traj_point_p waypoint,
		int* waypoint_index,
		carmen_navigator_config_t *nav_conf);
...
void carmen_planner_ackerman_set_map(carmen_map_p map,
...
void carmen_planner_ackerman_set_goal_list(carmen_ackerman_traj_point_t *goal_list, int list_size, carmen_navigator_config_t *nav_conf);

int carmen_planner_ackerman_change_goal(carmen_navigator_config_t *nav_conf);

void carmen_planner_ackerman_regenerate_trajectory(carmen_navigator_config_t *nav_conf);
