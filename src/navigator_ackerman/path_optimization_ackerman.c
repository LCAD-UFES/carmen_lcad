...
carmen_conventional_astar_ackerman_kinematic_optimization_2(carmen_ackerman_traj_point_t point, double lenght, double phi, double v)
{
...
carmen_ackerman_traj_point_t
carmen_conventional_astar_ackerman_kinematic_optimization(carmen_ackerman_traj_point_t point, double lenght, double phi, double v)
{
	//phi = carmen_degrees_to_radians(phi);
...
double delta_phi(carmen_ackerman_traj_point_t x1, carmen_ackerman_traj_point_t x2, carmen_ackerman_traj_point_t x3)
{
	double delta_phi;
...
carmen_ackerman_traj_point_t delta_X(carmen_ackerman_traj_point_t x1, carmen_ackerman_traj_point_t x2)
{
	carmen_ackerman_traj_point_t delta_X;
	delta_X.x = (x1.x - x2.x);
	delta_X.y = (x1.y - x2.y);
	return delta_X;
}
...
double curvature_measure(carmen_ackerman_traj_point_p points, int length)
{
	int index;
	carmen_ackerman_traj_point_t X;
	double soma = 0;
...
double smoothness_measure(carmen_ackerman_traj_point_p points, int length)
{
	int index;
	carmen_ackerman_traj_point_t X;
	double soma = 0;
...
double avaliation(carmen_ackerman_traj_point_p points, int length)
{
	double result = 0;
...
void pertubation(carmen_ackerman_traj_point_p points, int length)
{
	int index;
...
void copy_points(carmen_ackerman_traj_point_p points1, carmen_ackerman_traj_point_p points2, int length)
{
	int index;
	for (index = 0; index < length; index++)
	{
...
void carmen_path_optimization(carmen_ackerman_traj_point_t start, carmen_ackerman_traj_point_t goal,carmen_planner_path_p path)
{
	...
	carmen_ackerman_traj_point_t last_point = path->points[length-1];
	carmen_ackerman_traj_point_p best_points;
	carmen_ackerman_traj_point_p new_points;
	best_points = calloc(length, sizeof(carmen_ackerman_traj_point_t));
	new_points = calloc(length, sizeof(carmen_ackerman_traj_point_t));
