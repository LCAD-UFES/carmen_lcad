...
publish_keymessage(char c)
{
	...
	err = IPC_publishData(CARMEN_SKELETON_MODULE_SENSOR_KEY_MESSAGE_NAME, &message);
	carmen_test_ipc_exit(err, "Could not publish", CARMEN_SKELETON_MODULE_SENSOR_KEY_MESSAGE_FMT);
}
