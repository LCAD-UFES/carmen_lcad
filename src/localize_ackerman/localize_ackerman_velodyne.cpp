...
int
localize_ackerman_velodyne_partial_scan_build_instanteneous_maps(
		...
		carmen_current_semi_trailer_data_t semi_trailer_data)
{
	...
	build_sensor_point_cloud(&(velodyne_data->points), 
			velodyne_data->intensity, &(velodyne_data->point_cloud_index), num_points,
...
int
localize_ackerman_variable_scan_build_instanteneous_maps(
		carmen_compact_map_t *local_compacted_map,
		carmen_compact_map_t *local_compacted_mean_remission_map, 
		carmen_map_t *local_map, 
		carmen_velodyne_variable_scan_message *msg,
		sensor_parameters_t *sensor_params, sensor_data_t *sensor_data, 
		double v, double phi,
		carmen_current_semi_trailer_data_t semi_trailer_data)
{
	...
	build_sensor_point_cloud(&(sensor_data->points), 
			sensor_data->intensity, &(sensor_data->point_cloud_index), num_points,
...
int
localize_ackerman_variable_scan_build_instanteneous_maps(carmen_compact_map_t *local_compacted_map,
		carmen_compact_map_t *local_compacted_mean_remission_map, carmen_map_t *local_map, carmen_velodyne_variable_scan_message *msg,
