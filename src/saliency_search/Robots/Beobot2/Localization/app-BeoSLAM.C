/*!@file Robots/Beobot2/app-BeoSLAM.C SLAMy HNB basement navigation */
// //////////////////////////////////////////////////////////////////// //
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/Beobot2/Localization/app-BeoSLAM.C $
// $Id: app-BeoSLAM.C 12962 2010-03-06 02:13:53Z irock $
//

#include "Component/ModelManager.H"
#include "Component/ModelComponent.H"
#include "Component/ModelOptionDef.H"
#include "Robots/Beobot2/Localization/BeoSLAM.H"
...
bool RobotBrainServiceService::start(int argc, char* argv[])
{
  ...
  itsMgr = new ModelManager("BeoSLAMService");

  LINFO("Starting BeoSLAM System");
  nub::ref<BeoSLAM>
    nav(new BeoSLAM(*itsMgr, "BeoSLAM", "BeoSLAM"));
  LINFO("BeoSLAM created");
  itsMgr->addSubComponent(nav);
  LINFO("BeoSLAM Added As a subcomponent");
  nav->init(communicator(), itsAdapter);
  LINFO("BeoSLAM initiated");
