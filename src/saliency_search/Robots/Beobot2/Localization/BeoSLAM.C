/*!@file Robots2/Beobot2/Hardware/BeoSLAM.C
...
// $HeadURL: svn://ilab.usc.edu/trunk/saliency/src/Robots/Beobot2/Localization/BeoSLAM.C
// $ $Id: BeoSLAM.C 12962 2010-03-06 02:13:53Z irock $
//
//////////////////////////////////////////////////////////////////////////
...
// ######################################################################
BeoSLAM::BeoSLAM(OptionManager& mgr,
...
// ######################################################################
Beobot2::MotorCommand BeoSLAM::computeBeoSLAM()
{
...
(const RobotSimEvents::EventMessagePtr& eMsg, const Ice::Current&)
{
  ...
  if(eMsg->ice_isA("::BeobotEvents::SLAMMessage"))
  {
    ...
    // compute navigation
    Beobot2::MotorCommand cmd = computeBeoSLAM();
...
// ######################################################################
void BeoSLAM::updateMotor(double tran, double rot)
{
