...
void Matcher::pushBack (uint8_t *I1,uint8_t* I2,int32_t* dims,const bool replace) {
  ...
  if (replace) {
    ...
    dims_p[1]   = dims_c[1];
    dims_p[2]   = dims_c[2];
    //std::cout <<<< "m1p2:" << m1p2 << " m1p2:" << n1p2 << " m2p2:" << m2p2 << " n2p2:" << n2p2
    //<< " m1c2:" << m1c2 << " n1c2:"<< n1c2 << " m2c2:" << m2c2 << " n2c2:" << n2c2
  }
...
//    printf("m1p2 %ul,n1p2 %ul, m2p2 %ul, n2p2 %ul, m1c2 %ul, n1c2 %ul, m2c2 %ul, n2c2 %ul\n",
//      m1p2,n1p2,m2p2,n2p2,m1c2,n1c2,m2c2,n2c2);
    //std::cout << "m1p2:" << m1p2 << " n1p2:" << n1p2 << " m2p2:" << m2p2 << " n2p2:" << n2p2
    //<< " m1c2:" << m1c2 << " n1c2:"<< n1c2 << " m2c2:" << m2c2 << " n2c2:" << n2c2
    //<< std::endl;
...
void Matcher::computeFeatures (uint8_t *I,const int32_t* dims,int32_t* &max1,int32_t &num1,int32_t* &max2,int32_t &num2,uint8_t* &I_du,uint8_t* &I_dv,uint8_t* &I_du_full,uint8_t* &I_dv_full) {
  ...
  //  (uint8_t *I,const int32_t* dims,int32_t* &max1,int32_t &num1,int32_t* &max2,int32_t &num2,uint8_t* &I_du,uint8_t* &I_dv,uint8_t* &I_du_full,uint8_t* &I_dv_full) {
  //computeFeatures(I1c,dims_c,m1c1,n1c1,m1c2,n1c2,I1c_du,I1c_dv,I1c_du_full,I1c_dv_full);
  //if (I2!=0)
  //  computeFeatures(I2c,dims_c,m2c1,n2c1,m2c2,n2c2,I2c_du,I2c_dv,I2c_du_full,I2c_dv_full);
  //std::cout << "max1,m1c1:" << max1 << " num1,n1c1:"<< num1 << " max2,m1c2:"<< max2 << " num2,n1c2:"<< num2 << " I_du:" << I_du << " I_dv:"<< I_dv << " I_duf:" << I_du_full << " I_dvf:" << I_dv_full << std::endl;
...
void Matcher::matching (int32_t *m1p,int32_t *m2p,int32_t *m1c,int32_t *m2c,
  ...
  std::cout << "p_matched size in matching " <<  p_matched.size() << std::endl; 
  // free memory
  free(M);
  delete []k1p;
  delete []k2p;
