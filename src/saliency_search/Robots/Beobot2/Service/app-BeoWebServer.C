/*!@file Robots/Beobot2/app-BeoWebServer.C Web interface ICE
  modules */
// //////////////////////////////////////////////////////////////////// //
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/Beobot2/app-BeoWebServer.C $
// $Id: app-BeoWebServer.C 15181 2012-02-28 03:21:09Z beobot $
//
...
#endif	
{
  ...
  itsMgr = new ModelManager("BeoWebServerService");

  LINFO("Starting BeoWebServer System");
  nub::ref<BeoWebServer>
    webserver(new BeoWebServer(*itsMgr, "BeoWebServer", "BeoWebServer"));
  LINFO("BeoWebServer created");
  itsMgr->addSubComponent(webserver);
  LINFO("BeoWebServer Added As a subcomponent");
  webserver->init(communicator(), itsAdapter);
  LINFO("BeoWebServer initiated");
