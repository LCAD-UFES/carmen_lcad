/*!@file Robots/Beobot2/Navigation/ND_Navigation/app-ND_Navigation.C
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/Beobot2/Navigation/ND_Navigation/app-ND_Navigation.C $
// $Id: app-ND_Navigation.C 12962 2010-03-06 02:13:53Z irock $
//
...
bool RobotBrainServiceService::start(int argc, char* argv[])
{
  ...
  itsMgr = new ModelManager("ND_NavigationService");

  LINFO("Starting ND_Navigation System");
  nub::ref<ND_Navigation>
    nav(new ND_Navigation(*itsMgr, "ND_Navigation", "ND_Navigation"));
  LINFO("ND_Navigation created");
  itsMgr->addSubComponent(nav);
  LINFO("ND_Navigation Added As a subcomponent");
  nav->init(communicator(), itsAdapter);
  LINFO("ND_Navigation initiated");
