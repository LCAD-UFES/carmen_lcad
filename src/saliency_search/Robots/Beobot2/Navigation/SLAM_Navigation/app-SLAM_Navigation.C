/*!@file Robots/Beobot2/app-SLAM_Navigation.C SLAM HNB basement navigation */
// //////////////////////////////////////////////////////////////////// //
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/Beobot2/Navigation/SLAM_Navigation/app-SLAM_Navigation.C $
// $Id: app-SLAM_Navigation.C 12962 2010-03-06 02:13:53Z irock $
//
...
bool RobotBrainServiceService::start(int argc, char* argv[])
{
  ...
  itsMgr = new ModelManager("SLAM_NavigationService");

  LINFO("Starting SLAM_Navigation System");
  nub::ref<SLAM_Navigation>
    nav(new SLAM_Navigation(*itsMgr, "SLAM_Navigation", "SLAM_Navigation"));
  LINFO("SLAM_Navigation created");
  itsMgr->addSubComponent(nav);
  LINFO("SLAM_Navigation Added As a subcomponent");
  nav->init(communicator(), itsAdapter);
  LINFO("SLAM_Navigation initiated");
