/*!@file Robots2/Beobot2/Hardware/Hack_Navigation.C
 hacky HNB basement navigation                                 */
// //////////////////////////////////////////////////////////////////// //
...
// $HeadURL: svn://ilab.usc.edu/trunk/saliency/src/Robots/Beobot2/Navigation/Hack_Navigation/Hack_Navigation.C
// $ $Id: Hack_Navigation.C 12962 2010-03-06 02:13:53Z irock $
//
//////////////////////////////////////////////////////////////////////////

#include "Robots/Beobot2/Navigation/Hack_Navigation/Hack_Navigation.H"
...
// ######################################################################
Hack_Navigation::Hack_Navigation(OptionManager& mgr,
...
// ######################################################################
Hack_Navigation::~Hack_Navigation()
{ }

// ######################################################################
void Hack_Navigation::start1()
{
}

// ######################################################################
void Hack_Navigation::registerTopics()
{
...
// ######################################################################
void Hack_Navigation::evolve()
{ }

// ######################################################################
Beobot2::MotorCommand Hack_Navigation::computeHack_Navigation()
{
...
// ######################################################################
void Hack_Navigation::updateMessage
(const RobotSimEvents::EventMessagePtr& eMsg, const Ice::Current&)
{
  ...
  if(eMsg->ice_isA("::BeobotEvents::LRFMessage"))
  {
    ...
    // compute navigation
    Beobot2::MotorCommand cmd = computeHack_Navigation();
...
// ######################################################################
void Hack_Navigation::updateMotor(double tran,double rot)
{
