/*!@file Robots/Beobot2/Hardware/app-BeoLRF.C to to 3d scan on URG-04LX
 Laser Range Finder with Dynamixel RX-24F Servo*/
// //////////////////////////////////////////////////////////////////// //
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/Beobot2/Hardware/app-BeoTiltLRF.C $
// $Id: app-BeoTiltLRF.C 15346 2012-07-27 23:08:38Z kai $
//
...
//  SimEventsUtils::createTopic(communicator(), "BeoLRFMessageTopic");
  ...
  nub::ref<BeoTiltLRF> lrf(new BeoTiltLRF(*itsMgr, "BeoLRF", "BeoLRF"));
