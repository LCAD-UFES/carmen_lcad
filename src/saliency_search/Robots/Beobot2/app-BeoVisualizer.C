/*!@file Robots/Beobot2/app-BeoVisualizer.C Visualizer for all modules */
// //////////////////////////////////////////////////////////////////// //
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/Beobot2/app-BeoVisualizer.C $
// $Id: app-BeoVisualizer.C 15181 2012-02-28 03:21:09Z beobot $
//
...
#endif	
{
  ...
  itsMgr = new ModelManager("BeoVisualizerService");

  LINFO("Starting BeoVisualizer System");
  nub::ref<BeoVisualizer>
    visualizer(new BeoVisualizer(*itsMgr, "BeoVisualizer", "BeoVisualizer"));
  LINFO("BeoVisualizer created");
  itsMgr->addSubComponent(visualizer);
  LINFO("BeoVisualizer Added As a subcomponent");
  visualizer->init(communicator(), itsAdapter);
  LINFO("BeoVisualizer initiated");
