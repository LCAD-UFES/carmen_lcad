/*!@file Robots/Beobot2/app-BeoLogger.C to log data from all the Beobot ICE
  modules */
// //////////////////////////////////////////////////////////////////// //
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/Beobot2/app-BeoLogger.C $
// $Id: app-BeoLogger.C 15346 2012-07-27 23:08:38Z kai $
//
...
#endif	
{
  ...
  itsMgr = new ModelManager("BeoLoggerService");

  LINFO("Starting BeoLogger System");
  nub::ref<BeoLogger>
    logger(new BeoLogger(*itsMgr, "BeoLogger", "BeoLogger"));
  LINFO("BeoLogger created");
  itsMgr->addSubComponent(logger);
  LINFO("BeoLogger Added As a subcomponent");
  logger->init(communicator(), itsAdapter);
  LINFO("BeoLogger initiated");
