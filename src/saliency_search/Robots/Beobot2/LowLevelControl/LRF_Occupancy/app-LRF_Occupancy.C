/*!@file Robots/Beobot2/app-LRF_Occupancy.C to log data from all the Beobot ICE
  modules */
// //////////////////////////////////////////////////////////////////// //
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/Beobot2/LowLevelControl/LRF_Occupancy/app-LRF_Occupancy.C $
// $Id: app-LRF_Occupancy.C 12962 2010-03-06 02:13:53Z irock $
//
...
bool RobotBrainServiceService::start(int argc, char* argv[])
{
  ...
  itsMgr = new ModelManager("LRF_OccupancyService");

  LINFO("Starting LRF_Occupancy System");
  nub::ref<LRF_Occupancy>
    nav(new LRF_Occupancy(*itsMgr, "LRF_Occupancy", "LRF_Occupancy"));
  LINFO("LRF_Occupancy created");
  itsMgr->addSubComponent(nav);
  LINFO("LRF_Occupancy Added As a subcomponent");
  nav->init(communicator(), itsAdapter);
  LINFO("LRF_Occupancy initiated");
