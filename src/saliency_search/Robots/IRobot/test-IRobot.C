...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/IRobot/test-IRobot.C $
// $Id: test-IRobot.C 12962 2010-03-06 02:13:53Z irock $
//
...
int main(int argc, char** argv)
{
  ...
  try {
    ...
    Image<PixRGB<byte> > iRobotImg(256,256, ZEROS);
