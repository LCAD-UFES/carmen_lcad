...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Robots/HarrierBot/test-harrierSim.C $
// $Id: test-harrierSim.C 12962 2010-03-06 02:13:53Z irock $
//
...
void handle_keys(nub::soft_ref<OutputFrameSeries> ofs, nub::soft_ref<HarrierSim> harrierSim)
{
...
int main(int argc, char *argv[])
{
  ...
  nub::soft_ref<HarrierSim> harrierSim(new HarrierSim(manager));
