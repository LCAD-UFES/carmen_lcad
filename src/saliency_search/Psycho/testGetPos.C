/*!@file Psycho/testGetPos.C test if we can get the instanteous eye position from the eyeTracker */
...
// $HeadURL: svn://isvn.usc.edu/software/invt/trunk/saliency/src/Psycho/testGetPos.C $
// $Id:
//
