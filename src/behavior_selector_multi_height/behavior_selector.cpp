...
static carmen_obstacle_distance_mapper_map_message *current_map_level1 = NULL;
...
void
behavior_selector_update_map_level1(carmen_obstacle_distance_mapper_map_message *map)
{
	current_map_level1 = map;
}
