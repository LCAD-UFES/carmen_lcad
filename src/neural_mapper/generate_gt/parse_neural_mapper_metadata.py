...
def getRoi(mat, x, y, roi):
    ...
    roi_y_min = (y - half)
    roi_y_max = (y + half)
    # Se algum valor ter dimensoes que passam o tamanho da imagem, vai para proximo arquivo
...
outpath = "/dados/neural_mapper/Teste/"
radius = 60  # metros
