  ...
  --[[
   ...
   for t = 1, trainData:size(), opt.batchSize do
      ...
      local eval_E = function(w)
         ...
         image.save("caco/caco" .. t  .. ".png", xx[1][1]:add(0.1))
         labelImg = y[1][1]
         image.save("caco/caco" .. t  .. "-2.png", labelImg)
         labelImg = y[1][2]
         image.save("caco/caco" .. t  .. "-3.png", labelImg)
         labelImg = yt[1]:clone()
         labelImg:add(-1)
         image.save("caco/caco" .. t  .. "-4.png", labelImg)
