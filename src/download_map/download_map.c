...
//	sprintf(url, "http://dev.virtualearth.net/REST/v1/Imagery/Map/Aerial/%lf,%lf/19?key=AkIKEuNuD1217R1ETJyDlYgGXcHUrRtO0T6ueaunnhCH-uSWglO93UJlALuQAdm2&mapSize=900,900",latitude, longitude);
	sprintf(url,
			"http://maps.googleapis.com/maps/api/staticmap?center=%lf,%lf&zoom=%d&size=%dx%d&sensor=false&maptype=%s&key=AIzaSyD44pp1x_H-ru0iOOz2jtL1md3pm7uy5g0",
			latitude,
			longitude,
			zoom,
			width,
