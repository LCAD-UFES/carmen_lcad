...
localize_ackerman_globalpos_message_handler(carmen_localize_ackerman_globalpos_message *msg)
{
	...
	*GlobalState::localizer_pose = {msg->globalpos.x, msg->globalpos.y, msg->globalpos.theta,  msg->num_trailers, {0.0}}; //Adicionar num_trailers
	...
	for (size_t z = 0; z < MAX_NUM_TRAILERS; z++)
		GlobalState::localizer_pose->trailer_theta[z] =  msg->globalpos.theta - msg->trailer_theta[z]; // Transformar em beta para o build_and_follow_path funcionar corretamente
...
simulator_ackerman_truepos_message_handler(carmen_simulator_ackerman_truepos_message *msg)
{
	...
	*GlobalState::localizer_pose = {msg->truepose.x, msg->truepose.y, msg->truepose.theta, msg->num_trailers, {0.0}};
	for (size_t z = 0; z < MAX_NUM_TRAILERS; z++)
		GlobalState::localizer_pose->trailer_theta[z] = msg->truepose.theta - msg->trailer_theta[z]; // Transformar em beta para o build_and_follow_path funcionar corretamente
