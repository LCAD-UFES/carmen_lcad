...
void
carmen_map_server_subscribe_multi_height_offline_map(carmen_map_server_offline_map_message *message,
		carmen_handler_t handler,
		carmen_subscribe_t subscribe_how,
		int height_level)
{
	carmen_subscribe_message(CARMEN_MAP_SERVER_MULTI_HEIGHT_OFFLINE_MAP_NAME(height_level),
				CARMEN_MAP_SERVER_MULTI_HEIGHT_OFFLINE_MAP_FMT,
				message, sizeof(carmen_map_server_offline_map_message),
				handler, subscribe_how);
}
...
void carmen_map_server_subscribe_multi_height_cost_map(
		...
		int height_level)
{
	carmen_subscribe_message(CARMEN_MAP_SERVER_MULTI_HEIGHT_COST_MAP_NAME(height_level),
			CARMEN_MAP_SERVER_MULTI_HEIGHT_COST_MAP_FMT,
			message, sizeof(carmen_map_server_cost_map),
			handler, subscribe_how);
}
...
void carmen_map_server_subscribe_multi_height_compact_cost_map(
		...
		int height_level)
{
	carmen_subscribe_message(CARMEN_MAP_SERVER_MULTI_HEIGHT_COMPACT_COST_MAP_NAME(height_level),
			CARMEN_MAP_SERVER_MULTI_HEIGHT_COMPACT_COST_MAP_FMT,
			message, sizeof(carmen_map_server_compact_cost_map_message),
			handler, subscribe_how);
}
...
void
carmen_map_server_publish_multi_height_offline_map_message(carmen_map_t *carmen_map, double timestamp, int height_level)
{
	IPC_RETURN_TYPE err;
	static carmen_map_server_offline_map_message msg;
...
//	strcpy(msg.config.origin, carmen_map->config.origin);
	...
	err = IPC_publishData(CARMEN_MAP_SERVER_MULTI_HEIGHT_OFFLINE_MAP_NAME(height_level), &msg);
	carmen_test_ipc_exit(err, "Could not publish", CARMEN_MAP_SERVER_MULTI_HEIGHT_OFFLINE_MAP_NAME(height_level));
}
...
void
carmen_map_server_publish_multi_height_cost_map_message(carmen_map_t *carmen_map, double timestamp, int height_level)
{
	IPC_RETURN_TYPE err;
	static carmen_map_server_cost_map msg;
...
//	msg.cost_map_type = cost_map_type;
	...
	err = IPC_publishData(CARMEN_MAP_SERVER_MULTI_HEIGHT_COST_MAP_NAME(height_level), &msg);
	carmen_test_ipc_exit(err, "Could not publish", CARMEN_MAP_SERVER_MULTI_HEIGHT_COST_MAP_NAME(height_level));
}
...
void
carmen_map_server_publish_multi_height_compact_cost_map_message(carmen_compact_map_t *carmen_map, double timestamp, int height_level)
{
	IPC_RETURN_TYPE err;
	static carmen_map_server_compact_cost_map_message msg;
	...
	err = IPC_publishData(CARMEN_MAP_SERVER_MULTI_HEIGHT_COMPACT_COST_MAP_NAME(height_level), &msg);
	carmen_test_ipc_exit(err, "Could not publish", CARMEN_MAP_SERVER_MULTI_HEIGHT_COMPACT_COST_MAP_NAME(height_level));
}
...
void
carmen_map_server_define_multi_height_offline_map_message(int height_level)
{
	IPC_RETURN_TYPE err;

	err = IPC_defineMsg(CARMEN_MAP_SERVER_MULTI_HEIGHT_OFFLINE_MAP_NAME(height_level), IPC_VARIABLE_LENGTH,
			CARMEN_MAP_SERVER_MULTI_HEIGHT_OFFLINE_MAP_FMT);
	carmen_test_ipc_exit(err, "Could not define", CARMEN_MAP_SERVER_MULTI_HEIGHT_OFFLINE_MAP_NAME(height_level));
}
...
void
carmen_map_server_define_multi_height_cost_map_message(int height_level)
{
	IPC_RETURN_TYPE err;

	err = IPC_defineMsg(CARMEN_MAP_SERVER_MULTI_HEIGHT_COST_MAP_NAME(height_level), IPC_VARIABLE_LENGTH,
			CARMEN_MAP_SERVER_MULTI_HEIGHT_COST_MAP_FMT);
	carmen_test_ipc_exit(err, "Could not define", CARMEN_MAP_SERVER_MULTI_HEIGHT_COST_MAP_NAME(height_level));
}
...
void
carmen_map_server_define_multi_height_compact_cost_map_message(int height_level)
{
	IPC_RETURN_TYPE err;

	err = IPC_defineMsg(CARMEN_MAP_SERVER_MULTI_HEIGHT_COMPACT_COST_MAP_NAME(height_level), IPC_VARIABLE_LENGTH,
			CARMEN_MAP_SERVER_MULTI_HEIGHT_COMPACT_COST_MAP_FMT);
	carmen_test_ipc_exit(err, "Could not define", CARMEN_MAP_SERVER_MULTI_HEIGHT_COMPACT_COST_MAP_NAME(height_level));
}
