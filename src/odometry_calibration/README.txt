...
2. Execute o programa:
 ./calibrate_bias_from_log --gps_to_use 2 --use_non_linear_phi 0 -i 300 /dados/log_estacionameno_ambiental_20190503-ford-fusion-2.txt ../src/carmen-ford-fusion.ini caco.txt poses.txt poses_opt.txt
	...
	Notas:
        - Para executar a calibacao da odometria usando a mensagem velodyne_variable_scan_message: adicionar a flag "-use_lidar X" ao final da linha de comando (X é o ID da mensagem podendo variar de 0:15)
