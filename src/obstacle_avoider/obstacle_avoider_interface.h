...
void carmen_obstacle_avoider_publish_base_ackerman_motion_command(carmen_robot_and_trailers_motion_command_t *motion_commands, int num_motion_commands, double timestamp);
