...
static carmen_ackerman_traj_point_t *carmen_driving_playback_poses_ahead;
...
static int
carmen_driving_playback_play_find_nearest_poses_ahead(double x, double y, double yaw, double timestamp /* only for debugging */, carmen_ackerman_traj_point_t *poses_ahead, int num_poses_ahead_max, int *rddf_annotations, double distance_between_waypoints)
{
...
main(int argc, char **argv)
{
	...
	carmen_driving_playback_poses_ahead = (carmen_ackerman_traj_point_t *) calloc (carmen_driving_playback_num_poses_ahead_max, sizeof(carmen_ackerman_traj_point_t));
