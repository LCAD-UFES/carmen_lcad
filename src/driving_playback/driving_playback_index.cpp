...
int
fill_in_waypoints_array(long timestamp_index_position, carmen_ackerman_traj_point_t *poses_ahead, int num_poses_desired, carmen_ackerman_traj_point_t *last_pose_acquired, int *annotations, double distance_between_waypoints)
{
	double dist;
...
int
get_more_more_poses_from_begining(int num_poses_desired, carmen_ackerman_traj_point_t* poses_ahead, carmen_ackerman_traj_point_t last_pose_acquired_at_end_of_index, int num_poses_acquired_before_end_of_index, int *annotations, double distance_between_waypoints)
{
	double dist;
	int i, num_poses_aquired;
	carmen_ackerman_traj_point_t last_pose, current_pose;
...
int
carmen_search_next_poses_index(double x, double y, double yaw, double timestamp /* only for debugging */, carmen_ackerman_traj_point_t* poses_ahead, int num_poses_desired, int *annotations, double distance_between_waypoints)
{
