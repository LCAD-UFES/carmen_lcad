...
killall task_manager go2_driver_node can_to_wirelesscontroller ros_to_carmen_odometry
killall roslaunch open_manipulator_controller open_manipulator_controller.launch usb_port:=/dev/open_manipulator
killall argos_drivers
pkill -f ros2
