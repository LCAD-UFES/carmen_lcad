...
mkdir traffic_light_db

dentro da traffic_light_db/ crie a pasta img
	mkdir traffic_light_db/img
Rode o extrator do BD
	./traffic_light 3 -generate_database on -database_path traffic_light_db/
...
após gere um novo arquivo retirando o ROI do final da linha para conter apenas o caminho da imagem (positivas) 
	...
	cat ground_truth | awk '{print $1}' > positives.txt
...
Agora use o programa create_division para gerar os arquivos de treino, teste e validacao #COM PROBLEMA!
...
Separe o ground truth apenas do arquivo de treino
